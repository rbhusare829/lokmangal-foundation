                    ...
                    <div class="right-column float_right">
                        <div class="lang-dropdown-wrapper">
                            ...
                            <div class="lang-dropdown-menu">
                                <a href="../testimonials.html" class="">English</a>
                                <a href="testimonials.html" class="active">मराठी</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="inner-banner has-base-color-overlay text-center" style="background: url(../images/background/top-banner.jpg);">
    <div class="container">
        <div class="box">
            <h1 style="font-size: 24px;">अभिप्राय</h1>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="pull-left">
            <ul class="list-inline link-list">
                ...
                <li>
                    <a href="about.html">फाऊंडेशन बद्दल</a>
                </li>
